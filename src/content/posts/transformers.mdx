...
import decoder_img from "../assets/images/transformers/encoder_decoder_demo.png";
import transformer_img from "../assets/images/transformers/transformer_block.webp";
import nn_img from "../assets/images/neural_networks/simple_nn_ex.png";
...
Some useful terminology to know:
...
- **LLM Vocabulary:** this is a predefined "vocabulary" of words that contains all
  the words the LLM will be trained on. For example: GPT-3 contains a 100,261 token
  vocabulary. This means that GPT-3 could recognise different 100,261 words, similar to how
...
<figure>
  <img
    src={transformer_img.src}
    alt="Image of transformer block"
    width="400"
  ...
  >
    Figure 1: Transformer block from "Attention Is All You Need".
  </figcaption>
</figure>
...
attention mechnism is and what it does [2].
...
<figure>
  ...
  >
    Figure 3: Simple demonstration of encoder and decoders.
  </figcaption>
</figure>
...
3. Further Reading: The Illustrated Transformer by Jay Alammar: https://jalammar.github.io/illustrated-transformer/
