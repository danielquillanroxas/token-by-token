---
title: "Learning to Speak: How TTS Reads Texts"
date: "2026-04-13"
author: "D. Roxas"
description: "An introduction to Text Analysis (for TTS Systems)"
tags: ["TTS", "text-to-speech", "NLP"]
---

import ttsImage from '../assets/images/TTS/TTS.png';
import ttsImage2 from '../assets/images/TTS/TTS_System.png';
import ttsImage3 from '../assets/images/TTS/part_of_speech_tagging.webp';
...
<figure>
    <img src={ttsImage3.src} alt="My Image" width="700" style={{ display: "block", margin: "0 auto" }} />
    <figcaption style={{ fontSize: "0.85em", color: "gray", marginTop: "0.5em",  textAlign: "center" }}>
...
9. https://www.politesi.polimi.it/retrieve/a0ad5454-4e82-4041-a757-5660d683016e/Executive_Summary_Duration_Modelling_for_Expressive_TTS.pdf
10. https://en.wikipedia.org/wiki/Speech_synthesis
11. https://www.geeksforgeeks.org/nlp/nlp-part-of-speech-default-tagging/